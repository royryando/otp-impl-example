...
public class VerihubsFCVerify implements Runnable {
    private final String phoneNumber;

    private final String otp;

    public VerihubsFCVerify(String phoneNumber, String otp) {
    ...
    public void run() {
        try {
            // Set URL
            URL url = new URL("https://api.verihubs.com/v2/flashcall/verify");
            ...
            System.out.println("Verihubs\t: FC Verify ("+this.otp+"): " + jsonResponse);
