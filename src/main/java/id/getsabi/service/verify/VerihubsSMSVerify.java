...
public class VerihubsSMSVerify implements Runnable {
    private final String phoneNumber;

    private final String otp;

    public VerihubsSMSVerify(String phoneNumber, String otp) {
    ...
    public void run() {
        try {
            // Set URL
            URL url = new URL("https://api.verihubs.com/v1/otp/verify");
            ...
            System.out.println("Verihubs\t: SMS Verify ("+this.otp+"): " + jsonResponse);
